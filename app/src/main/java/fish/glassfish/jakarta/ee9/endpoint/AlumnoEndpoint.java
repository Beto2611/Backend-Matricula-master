...
import backend.matricula.controllers.AlumnoController;
...
@ServerEndpoint(value = "/buscarAlumnoPorId", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
