...
import backend.matricula.controllers.ProfesorController;
...
@ServerEndpoint(value = "/profesor", decoders = {JsonObjectDecoder.class}, encoders = {JsonObjectEncoder.class})
